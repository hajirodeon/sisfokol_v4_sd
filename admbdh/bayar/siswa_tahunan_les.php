...
//nilai
$filenya = "siswa_tahunan_les.php";
$judul = "Laporan Tahunan : Uang LES";
...
[<a href="siswa_tahunan_les_prt.php?tapelkd='.$tapelkd.'"><img src="'.$sumber.'/img/print.gif" border="0" width="16" height="16"></a>]
</td>
</tr>
</table>';
...
for ($i=1;$i<=12;$i++)
	...
	$qcc1 = mysql_query("SELECT DISTINCT(siswa_uang_les.kd_siswa) AS kd_siswa, ".
				...
				"AND round(DATE_FORMAT(siswa_uang_les.tgl_bayar, '%m')) = '$ibln' ".
				"AND round(DATE_FORMAT(siswa_uang_les.tgl_bayar, '%Y')) = '$ithn' ".
...
//ketahui jumlah uang les-nya... setahun
