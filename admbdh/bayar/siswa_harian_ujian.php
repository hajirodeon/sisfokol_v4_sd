...
//nilai
$filenya = "siswa_harian_ujian.php";
$judul = "Laporan Harian : Uang Ujian";
...
//query
$qcc = mysql_query("SELECT siswa_uang_ujian.*, ".
						...
						"AND round(DATE_FORMAT(siswa_uang_ujian.tgl_bayar, '%d')) = '$utgl' ".
...
{
echo '<br>
[<a href="siswa_harian_ujian_prt.php?tapelkd='.$tapelkd.'&utgl='.$utgl.'&ubln='.$ubln.'&uthn='.$uthn.'"><img src="'.$sumber.'/img/print.gif" border="0" width="16" height="16"></a>]
