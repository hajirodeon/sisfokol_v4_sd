...
//PROSES ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//re-direct print...
$ke = "siswa_pangkal.php?tapelkd=$tapelkd&nis=$nis";
...
<P>
<big>
<strong><u>BUKTI PEMBAYARAN UANG PANGKAL</u></strong>
</big>
</P>
<P>
<big>
...
$qccx1x = mysql_query("SELECT * FROM siswa_uang_pangkal ".
...
$rccx1x = mysql_fetch_assoc($qccx1x);
$ccx1x_tgl = $rccx1x['postdate'];
