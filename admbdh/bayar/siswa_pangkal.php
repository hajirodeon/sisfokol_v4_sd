...
//nilai
$filenya = "siswa_pangkal.php";
$judul = "Keuangan Siswa : Uang Pangkal";
...
if (($cc_nilai + $nil_bayar) > $pkl_nilai)
	{
	//re-direct
	$pesan = "Jumlah Uang Pangkal Yang Dibayarkan, Melebihi Jumlah Total Sisa Yang Ada. Harap Diperhatikan...!!";
	$ke = "$filenya?tapelkd=$tapelkd&nis=$nis";
	pekem($pesan,$ke);
	exit();
	}
...
//re-direct
$ke = "siswa_pangkal_prt.php?tapelkd=$tapelkd&nis=$nis";
xloc($ke);
exit();
}
}
