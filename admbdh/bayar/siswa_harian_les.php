...
//nilai
$filenya = "siswa_harian_les.php";
$judul = "Laporan Harian : Uang Les";
...
//query
$qcc = mysql_query("SELECT DISTINCT(siswa_uang_les.kd_siswa) AS kd_siswa, ".
			"m_siswa.* ".
			...
			"AND round(DATE_FORMAT(siswa_uang_les.tgl_bayar, '%d')) = '$utgl' ".
...
{
echo '<br>
[<a href="siswa_harian_les_prt.php?tapelkd='.$tapelkd.'&utgl='.$utgl.'&ubln='.$ubln.'&uthn='.$uthn.'"><img src="'.$sumber.'/img/print.gif" border="0" width="16" height="16"></a>]
