...
//nilai
$filenya = "siswa_bulanan_ulang.php";
$judul = "Laporan Bulanan : Uang Daftar Ulang";
...
echo '</select>
[<a href="siswa_bulanan_ulang_prt.php?tapelkd='.$tapelkd.'&utgl='.$utgl.'&ubln='.$ubln.'&uthn='.$uthn.'"><img src="'.$sumber.'/img/print.gif" border="0" width="16" height="16"></a>]
</td>
</tr>
</table>';
...
for ($i=1;$i<=$tkhir;$i++)
	...
	$qcc1 = mysql_query("SELECT m_siswa.*, ".
							...
							"AND siswa_uang_ulang.kd_tapel = '$tapelkd' ".
							"AND siswa_uang_ulang.nilai <> '' ".
							"AND round(DATE_FORMAT(siswa_uang_ulang.tgl_bayar, '%d')) = '$i' ".
...
//ketahui jumlah uang ulang-nya... sebulan
