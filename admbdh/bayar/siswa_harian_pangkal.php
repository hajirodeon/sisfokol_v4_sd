...
//nilai
$filenya = "siswa_harian_pangkal.php";
$judul = "Laporan Harian : Uang Pangkal";
...
{
echo '<br>
[<a href="siswa_harian_pangkal_prt.php?tapelkd='.$tapelkd.'&utgl='.$utgl.'&ubln='.$ubln.'&uthn='.$uthn.'"><img src="'.$sumber.'/img/print.gif" border="0" width="16" height="16"></a>]
