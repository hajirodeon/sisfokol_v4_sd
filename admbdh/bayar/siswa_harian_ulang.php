...
//nilai
$filenya = "siswa_harian_ulang.php";
...
{
echo '<br>
[<a href="siswa_harian_ulang_prt.php?tapelkd='.$tapelkd.'&utgl='.$utgl.'&ubln='.$ubln.'&uthn='.$uthn.'"><img src="'.$sumber.'/img/print.gif" border="0" width="16" height="16"></a>]
