...
if ($_POST['btnRST'])
	...
	//nek waka ....................................................................................................................
		...
		if (empty($pegawai))
			...
			//re-direct
			$pesan = "Silahkan tentukan dahulu yang menjadi Petugas Wakil Kurikulum...";
			pekem($pesan,$ke);
			exit();
			}
		else
			...
			if ($tsuk != 0)
				{
				//update
				mysql_query("UPDATE admin_waka SET kd_pegawai = '$pegawai'");
				}
			else
				{
				//insert
	...
	//nek inventaris ....................................................................................................................
		...
		if (empty($pegawai))
			...
			if ($tsuk != 0)
				{
				//update
				mysql_query("UPDATE admin_inv SET kd_pegawai = '$pegawai'");
				}
			else
				{
				//insert
	...
	//nek surat ....................................................................................................................
		...
		if (empty($pegawai))
			...
			//re-direct
			$pesan = "Silahkan tentukan dahulu yang menjadi Petugas Surat - Menyurat...";
			pekem($pesan,$ke);
			exit();
			}
		else
			...
			if ($tsuk != 0)
				{
				//update
				mysql_query("UPDATE admin_surat SET kd_pegawai = '$pegawai'");
				}
			else
				{
				//insert
	...
	//nek perpustakaan ....................................................................................................................
		...
		if (empty($pegawai))
			...
			if ($tsuk != 0)
				{
				//update
				mysql_query("UPDATE admin_pus SET kd_pegawai = '$pegawai'");
				}
			else
				{
				//insert
	...
	//nek bp/bk ....................................................................................................................
		...
		if (empty($pegawai))
			...
			//re-direct
			$pesan = "Silahkan tentukan dahulu yang menjadi Petugas BP/BK...";
			pekem($pesan,$ke);
			exit();
			}
		else
			...
			if ($tsuk != 0)
				{
				//update
				mysql_query("UPDATE admin_bk SET kd_pegawai = '$pegawai'");
				}
			else
				{
				//insert
	...
	//nek sms akademik ....................................................................................................................
		...
		if (empty($pegawai))
			...
			if ($tsuk != 0)
				{
				//update
				mysql_query("UPDATE admin_sms SET kd_pegawai = '$pegawai'");
				}
			else
				{
				//insert
...
<option value="'.$filenya.'?tpkd=tp09&tipe=Wakil Kurikulum">Wakil Kurikulum</option>
...
<option value="'.$filenya.'?tpkd=tp12&tipe=Inventaris">Inventaris</option>
<option value="'.$filenya.'?tpkd=tp13&tipe=Surat">Surat</option>
<option value="'.$filenya.'?tpkd=tp14&tipe=Perpustakaan">Perpustakaan</option>
<option value="'.$filenya.'?tpkd=tp15&tipe=BP/BK">BP/BK</option>
<option value="'.$filenya.'?tpkd=tp17&tipe=SMS Akademik">SMS Akademik</option>
</select>
</td>
</tr>
</table>';
