...
if ($_POST['btnIM'])
	...
	if (empty($mapelkd))
		...
		{
		//re-direct
		$ke = "nil_raport.php?tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&smtkd=$smtkd&mapelkd=$mapelkd&s=import";
		xloc($ke);
		exit();
		}
	}
...
if ($_POST['btnIM2'])
	...
	if (empty($filex_namex))
		...
		if ($ext_filex == ".xls")
			...
			//re-direct
			$ke = "nil_raport_import.php?tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&smtkd=$smtkd&mapelkd=$mapelkd&filex_namex=$filex_namex";
			xloc($ke);
			exit();
			}
		else
...
if ($_POST['btnSMP'])
	...
	//re-direct
	$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&mapelkd=$mapelkd&smtkd=$smtkd";
	xloc($ke);
	exit();
	}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
