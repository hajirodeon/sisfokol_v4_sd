...
for ($i=1;$i<=40;$i++)
	...
	echo'<option value="'.$filenya.'?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&mapelkd='.$mapelkd.'&smtkd='.$smtkd.'&pertemuan='.$i.'&utgl='.$cc_tgl.'&ubln='.$cc_bln.'&uthn='.$cc_thn.'">'.$i.' ['.$cc_tgl.' '.$arrbln[$cc_bln].''.$cc_thn.']</option>';
	}
...
for ($itgl=1;$itgl<=31;$itgl++)
	{
	echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&mapelkd='.$mapelkd.'&smtkd='.$smtkd.'&pertemuan='.$pertemuan.'&utgl='.$itgl.'">'.$itgl.'</option>';
	}
echo '</select>';
...
for ($i=1;$i<=12;$i++)
	...
	if ($i<=6) //bulan juli sampai desember
		...
		echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&mapelkd='.$mapelkd.'&smtkd='.$smtkd.'&pertemuan='.$pertemuan.'&utgl='.$utgl.'&ubln='.$ibln.'&uthn='.$tpx_thn1.'">'.$arrbln[$ibln].' '.$tpx_thn1.'</option>';
		}
		...
		echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&mapelkd='.$mapelkd.'&smtkd='.$smtkd.'&pertemuan='.$pertemuan.'&utgl='.$utgl.'&ubln='.$ibln.'&uthn='.$tpx_thn2.'">'.$arrbln[$ibln].' '.$tpx_thn2.'</option>';
		}
	}
