...
if ($_POST['btnBTL'])
	...
	//re-direct
	$ke = "nil_raport.php?tapelkd=$tapelkd&kelkd=$kelkd&mapelkd=$mapelkd&rukd=$rukd&smtkd=$smtkd";
	xloc($ke);
	exit();
	}
...
if ($_POST['btnIMx'])
	...
	if (empty($filex_namex))
		...
		$ke = "nil_raport.php?tapelkd=$tapelkd&kelkd=$kelkd&mapelkd=$mapelkd&rukd=$rukd&smtkd=$smtkd&s=import";
		pekem($pesan,$ke);
		exit();
		}
	else
