...
if (empty($tapelkd))
	...
	if ($tdty != 0)
		...
		do
			...
			<td>
			<a href="d/rangking.php?tapelkd='.$dty_tapelkd.'&kelkd='.$dty_kelkd.'&rukd='.$dty_rukd.'"
			title="RANGKING. Tahun Pelajaran = '.$ytapel_thn1.'/'.$ytapel_thn2.', Kelas = '.$ykel_kelas.', Ruang = '.$yru_ru.'">
			<img src="'.$sumber.'/img/preview.gif" width="16" height="16" border="0"></a>
			</td>
			<td>
