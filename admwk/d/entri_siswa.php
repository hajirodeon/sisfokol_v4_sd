...
//nilai
$filenya = "entri_siswa.php";
$judul = "Entri Data Siswa";
...
if ($_POST['btnCARI'])
	...
	if ((empty($crkd)) OR (empty($kunci)))
		...
		{
		//re-direct
		$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&crkd=$crkd&crtipe=$crtipe&kunci=$kunci";
		xloc($ke);
		exit();
		}
	}
...
if ($_POST['btnIM'])
	...
	if ((empty($kelkd)) OR (empty($tapelkd)))
		...
		{
		//re-direct
		$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&s=import";
		xloc($ke);
		exit();
		}
	}
...
if ($_POST['btnIM2'])
	...
	if (empty($filex_namex))
		...
		if ($ext_filex == ".xls")
			...
			//re-direct
			$ke = "entri_siswa_import.php?tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&filex_namex=$filex_namex";
			xloc($ke);
			exit();
			}
		else
...
if ($_POST['btnPRT'])
	...
	//re-direct
	$ke = "siswa_pdf.php?tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&swkd=$swkd";
	xloc($ke);
	exit();
	}
	...
	if (empty($filex_namex))
		...
		if ($ext_filex == ".jpg")
			...
			if (!file_exists($path1))
				...
				$path3 = "../../filebox/siswa/$swkd/$filex_namex";
				chmod($path3,0755);
				chmod($path2,0755);
				chmod($path1,0755);
...
if ($_POST['btnSMP'])
	...
	if ($a == "a")
		...
		if ($s == "edit")
			...
			if ($tcc > 1)
				...
				$ke = "$filenya?s=edit&tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&swkd=$swkd&a=a#a";
				pekem($pesan,$ke);
				exit();
				}
			else
		...
		if ($s == "baru")
			...
			if ((empty($nis)) OR (empty($nama)))
				...
				//re-direct
				$pesan = "Input Tidak Lengkap. Harap Diulangi...!";
				$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&s=baru&swkd=$swkd&a=$a#a";
				pekem($pesan,$ke);
				exit();
				}
			else
				...
				if ($tcc != 0)
					...
					$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&s=baru&swkd=$x&a=$a#a";
					pekem($pesan,$ke);
					exit();
					}
				else
					...
					//re-direct
					$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&s=edit&swkd=$swkd&a=$a#a";
					xloc($ke);
					exit();
					}
				}
	...
	//B. KETERANGAN TEMPAT TINGGAL /////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($s == "edit")
			...
			if ($tcc != 0)
				...
				//re-direct
				$ke = "$filenya?s=edit&tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&swkd=$swkd&a=b#b";
				xloc($ke);
				exit();
				}
			...
			//nek blm ada
				...
				//re-direct
				$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&s=edit&swkd=$swkd&a=b#b";
				xloc($ke);
				exit();
				}
			}
	...
	//C. KETERANGAN KESEHATAN //////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($s == "edit")
			...
			if ($tcc != 0)
				...
				//re-direct
				$ke = "$filenya?s=edit&tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&swkd=$swkd&a=c#c";
				xloc($ke);
				exit();
				}
			...
			//nek blm ada
				...
				//re-direct
				$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&s=edit&swkd=$swkd&a=c#c";
				xloc($ke);
				exit();
				}
			}
	...
	//D. KETERANGAN PENDIDIKAN /////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($s == "edit")
			...
			//re-direct
			$ke = "$filenya?s=edit&tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&swkd=$swkd&a=d#d";
			xloc($ke);
			exit();
			}
		}
	...
	//E. KETERANGAN TENTANG AYAH KANDUNG ///////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($s == "edit")
			...
			//re-direct
			$ke = "$filenya?s=edit&tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&swkd=$swkd&a=e#e";
			xloc($ke);
			exit();
			}
		}
	...
	//F. KETERANGAN TENTANG IBU KANDUNG ////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($s == "edit")
			...
			//re-direct
			$ke = "$filenya?s=edit&tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&swkd=$swkd&a=f#f";
			xloc($ke);
			exit();
			}
		}
	...
	//G. KETERANGAN TENTANG WALI ///////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($s == "edit")
			...
			//re-direct
			$ke = "$filenya?s=edit&tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&swkd=$swkd&a=g#g";
			xloc($ke);
			exit();
			}
		}
	...
	//H. KEGEMARAN SISWA ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($s == "edit")
			...
			//re-direct
			$ke = "$filenya?s=edit&tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&swkd=$swkd&a=h#h";
			xloc($ke);
			exit();
			}
		}
	...
	//I. KETERANGAN PERKEMBANGAN SISWA /////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($s == "edit")
			...
			//re-direct
			$ke = "$filenya?s=edit&tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&swkd=$swkd&a=i#i";
			xloc($ke);
			exit();
			}
		}
	...
	//J. KETERANGAN SETELAH SELESAI PENDIDIKAN /////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($s == "edit")
			...
			//re-direct
			$ke = "$filenya?s=edit&tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&swkd=$swkd&a=j#j";
			xloc($ke);
			exit();
			}
		}
...
echo 'Ruang : <strong>'.$ru_ruang.'</strong>
...
if (($s == "baru") OR ($s == "edit"))
	...
	(<a href="'.$filenya.'?s=edit&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&swkd='.$swkd.'&a=a#a" title="A. KETERANGAN TENTANG DIRI SISWA">EDIT</a>)
	</td>
	</tr>
	</table>
	<br>';
	...
	(<a href="'.$filenya.'?s=edit&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&swkd='.$swkd.'&a=b#b" title="B. KETERANGAN TEMPAT TINGGAL">EDIT</a>)
	</td>
	</tr>
	</table>
	<br>';
	...
	(<a href="'.$filenya.'?s=edit&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&swkd='.$swkd.'&a=c#c" title="C. KETERANGAN KESEHATAN">EDIT</a>)
	</td>
	</tr>
	</table>
	<br>';
	...
	(<a href="'.$filenya.'?s=edit&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&swkd='.$swkd.'&a=d#d" title="D. KETERANGAN PENDIDIKAN">EDIT</a>)
	</td>
	</tr>
	</table>
	<br>';
	...
	(<a href="'.$filenya.'?s=edit&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&swkd='.$swkd.'&a=e#e" title="E. KETERANGAN TENTANG AYAH KANDUNG">EDIT</a>)
	</td>
	</tr>
	</table>
	<br>';
	...
	(<a href="'.$filenya.'?s=edit&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&swkd='.$swkd.'&a=f#f" title="F. KETERANGAN TENTANG IBU KANDUNG">EDIT</a>)
	</td>
	</tr>
	</table>
	<br>';
	...
	(<a href="'.$filenya.'?s=edit&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&swkd='.$swkd.'&a=g#g" title="G. KETERANGAN TENTANG WALI">EDIT</a>)
	</td>
	</tr>
	</table>
	<br>';
	...
	(<a href="'.$filenya.'?s=edit&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&swkd='.$swkd.'&a=h#h" title="H. KEGEMARAN SISWA">EDIT</a>)
	</td>
	</tr>
	</table>
	<br>';
	...
	(<a href="'.$filenya.'?s=edit&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&swkd='.$swkd.'&a=i#i" title="I. KETERANGAN PERKEMBANGAN SISWA">EDIT</a>)
	</td>
	</tr>
	</table>
	<br>';
	...
	(<a href="'.$filenya.'?s=edit&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&swkd='.$swkd.'&a=j#j" title="J. KETERANGAN SETELAH SELESAI PENDIDIKAN">EDIT</a>)
	</td>
	</tr>
	</table>
	<br>';
	...
	if ($s == "import")
		...
		if ($crkd == "cr01")
			...
			$pages = $p->findPages($count, $limit);
			$result = mysql_query("$sqlresult LIMIT ".$start.", ".$limit);
			$target = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&rukd=$rukd&crkd=$crkd&crtipe=$crtipe&kunci=$kunci";
			$pagelist = $p->pageList($_GET['page'], $pages, $target);
			$data = mysql_fetch_array($result);
			}
		...
		<option value="'.$filenya.'?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd,'&crkd=cr01&crtipe=NIS&kunci='.$kunci.'">NIS</option>
		<option value="'.$filenya.'?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd,'&crkd=cr02&crtipe=Nama&kunci='.$kunci.'">Nama</option>
		</select>
		<input name="tapelkd" type="hidden" value="'.$tapelkd.'">
		<input name="kelkd" type="hidden" value="'.$kelkd.'">
		<input name="rukd" type="hidden" value="'.$rukd.'">
		...
		if ($count != 0)
			...
			do
				...
				<td>
				<a href="siswa_pdf.php?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&swkd='.$kd.'" target="_blank" title="PRINT..."><img src="'.$sumber.'/img/pdf.gif" width="16" height="16" border="0"></a>
				</td>
				<td valign="top">
				'.$nis.'
				</td>
