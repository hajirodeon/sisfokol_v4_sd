...
<option value="'.$filenya.'?swkd='.$swkd.'&skkd='.$skkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&jnskd=spi&jenis=SPI">SPI</option>
<option value="'.$filenya.'?swkd='.$swkd.'&skkd='.$skkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&jnskd=komite&jenis=Komite">Komite</option>
<option value="'.$filenya.'?swkd='.$swkd.'&skkd='.$skkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&jnskd=les&jenis=LES">LES</option>';
