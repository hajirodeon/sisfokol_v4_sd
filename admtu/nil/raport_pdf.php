...
//mapel
$pdf->SetX(15);
$pdf->Cell(45,15,'Mata Pelajaran',1,0,'C',1);
...
$nilx_total = nosql($rnilx['total']);
$nilx_rata = nosql($rnilx['rata']);
...
$pdf->Cell(15,5,'-',1,0,'L');
$pdf->Cell(10,5,$nilx_total,1,0,'L');
$pdf->Cell(35,5,xongkof($nilx_total),1,0,'L');
$pdf->Cell(10,5,'',1,0,'L');
$pdf->Cell(35,5,'',1,0,'L');
$pdf->Cell(15,5,'-',1,0,'L');
...
$pdf->Cell(15,5,'-',1,0,'L');
$pdf->Cell(10,5,$nilx_rata,1,0,'L');
$pdf->Cell(35,5,xongkof($nilx_rata),1,0,'L');
$pdf->Cell(10,5,'',1,0,'L');
$pdf->Cell(35,5,'',1,0,'L');
$pdf->Cell(15,5,'-',1,0,'L');
...
do
	...
	$qhi = mysql_query("SELECT m_mapel_kelas.*, m_mapel_kelas.kd AS mpkd, ".
				...
				"AND m_mapel_kelas.kd_kelas = '$kelkd' ".
				"AND m_mapel_kelas.kd_mapel = '$pelkd'");
	...
	$pdf->Cell(45,$nilY,$pel,1,0,'L');
	$pdf->Cell(120,$nilY,'',1,0,'L');


	//posisi
	$pdf->SetX(60);

	//looping NK 1 sampe 5.
	for ($i=1;$i<=5;$i++)
		{
		//sub
		...
		if ($dtu_nkd < $kkm)
			{
			$nhx_ket = "SK$i Belum Tercapai, ";
			}
		else if ($dtu_nkd == $kkm)
			{
			$nhx_ket = "SK$i Tercapai, ";
			}
		else if ($dtu_nkd > $kkm)
			{
			$nhx_ket = "SK$i Terlampaui, ";
			}

		$ket_k = $nhx_ket;
		$pdf->Cell(23,$nilY,$ket_k,0,0,'L');
		}
