...
//nilai
$filenya = "per_tgl_ijazah.php";
$judul = "Data Alumni per Tgl.Ijazah";
...
if (empty($tapelkd))
	...
	if ($crkd == "cr01")
		...
		$sqlcount = "SELECT m_siswa.*, ".
				...
				"DATE_FORMAT(m_siswa_perkembangan.tgl_ijazah, '%d') AS 2tgl, ".
				"DATE_FORMAT(m_siswa_perkembangan.tgl_ijazah, '%m') AS 2bln, ".
				"DATE_FORMAT(m_siswa_perkembangan.tgl_ijazah, '%Y') AS 2thn, ".
				"m_siswa.kd AS mskd, ".
	...
	if ($count != 0)
		{
		echo '[<a href="per_tgl_ijazah_prt.php?tapelkd='.$tapelkd.'"><img src="'.$sumber.'/img/print.gif" border="0" width="16" height="16"></a>]

		<p>
		<table width="100%" border="1" cellpadding="3" cellspacing="0">
		<tr bgcolor="'.$warnaheader.'">
		<td width="1">&nbsp;</td>
		<td width="150"><strong>Tgl.Ijazah</strong></td>
