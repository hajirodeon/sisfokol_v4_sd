...
$qdata = mysql_query("SELECT m_siswa.*, ".
			...
			"DATE_FORMAT(m_siswa_perkembangan.tgl_terima_ijazah, '%d') AS 2tgl, ".
			"DATE_FORMAT(m_siswa_perkembangan.tgl_terima_ijazah, '%m') AS 2bln, ".
			"DATE_FORMAT(m_siswa_perkembangan.tgl_terima_ijazah, '%Y') AS 2thn, ".
			"m_siswa.kd AS mskd, ".
