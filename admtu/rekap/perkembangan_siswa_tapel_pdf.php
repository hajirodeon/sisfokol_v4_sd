...
require("../../inc/class/perkembangan_siswa_tapel.php");
...
//nilai
$judul = "Rekap Data : Perkembangan Siswa per Tapel";
$judulz = $judul;
...
$pdf->WriteHTML($isi);
$pdf->Output("perkembangan_siswa_tapel.pdf",I);
?>