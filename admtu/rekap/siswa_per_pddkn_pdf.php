...
$q = mysql_query("SELECT m_siswa.*, ".
			...
			"m_siswa.kd AS mskd, ".
			"siswa_kelas.*, m_kelas.*, m_ruang.*, m_siswa_ayah.*, m_pendidikan.* ".
			"FROM m_siswa, siswa_kelas, m_kelas, m_ruang, m_siswa_ayah, m_pendidikan ".
			"WHERE siswa_kelas.kd_siswa = m_siswa.kd ".
			"AND siswa_kelas.kd_kelas = m_kelas.kd ".
			"AND siswa_kelas.kd_ruang = m_ruang.kd ".
			"AND m_siswa_ayah.kd_siswa = m_siswa.kd ".
			"AND m_siswa_ayah.kd_pendidikan = m_pendidikan.kd ".
			"AND siswa_kelas.kd_tapel = '$tapelkd' ".
			"ORDER BY m_pendidikan.pendidikan ASC");
