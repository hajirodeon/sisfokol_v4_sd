		...
		if ($s == "import")
			...
			if ($crkd == "cr02")
				...
				$sqlcount = "SELECT m_siswa.*, ".
								...
								"AND siswa_kelas.kd_tapel = '$tapelkd' ".
								"AND siswa_kelas.kd_kelas = '$kelkd' ".
								"AND m_siswa.nisn LIKE '%$kunci%' ".
								"ORDER BY round(m_siswa.nisn) ASC";
				$sqlresult = $sqlcount;
			...
			<option value="'.$filenya.'?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&crkd=cr02&crtipe=NISN&kunci='.$kunci.'">NISN</option>
			<option value="'.$filenya.'?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&crkd=cr03&crtipe=Nama&kunci='.$kunci.'">Nama</option>
			</select>
			<input name="tapelkd" type="hidden" value="'.$tapelkd.'">
			<input name="kelkd" type="hidden" value="'.$kelkd.'">
			...
			if ($count != 0)
				...
				do
					...
					$x_usernamex = balikin($data['usernamex']);
					$x_passwordx = balikin($data['passwordx']);
